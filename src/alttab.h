...
#define DEFICONW 32
#define DEFICONH 32
#define DEFBORDERW 10
#define DEFTHEME "hicolor"
#define DEFFRAMEW 8
// #define DEFFONT "xft:DejaVu Sans Condensed-15"
...
#define COLINACT 4
#define NCOLORS 5
#define DEFCOLBG "#1e1d2d"
#define DEFCOLFG "#d9e0ee"
#define DEFCOLFRAME "#ddb6f2"
#define DEFCOLBORDER "#1d1d2d"
